...
\title[IMF (6)]{Informatika pro moderní fyziky (6)\\Vstupní soubory pro výpočetní programy\\Tvorba textových dokumentů}

\author[Franti\v{s}ek HAVL\r{U}J, ORF ÚJV Řež]{Franti\v{s}ek HAVL\r{U}J\\{\scriptsize \emph{e-mail: haf@ujv.cz}}}

\date{akademický rok 2016/2017\\9. listopadu 2016}
...
\begin{frame}{}
  \begin{itemize}
    \item načítání složitějšího datového souboru
    \item důkladné procvičení práce s hashi a poli
  \end{itemize}
\end{frame}
...
\begin{frame}{Chytáky a zádrhele}
  ...
  \begin{itemize}
    \item již známá funkce \texttt{gsub} pro nahrazení jednoho řetězce jiným
