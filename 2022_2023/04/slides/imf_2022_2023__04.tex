...
\title[IMF (4)]{Informatika pro moderní fyziky (3)\\práce s tabulkami, hromadné zpracování dat, rozšíření RubyGems, ladění programů}

\author[Franti\v{s}ek HAVL\r{U}J, ORF ÚJV Řež]{Franti\v{s}ek HAVL\r{U}J\\{\scriptsize \emph{e-mail: haf@ujv.cz}}}

\date{akademický rok 2022/2023, 19. října 2022}
...
\begin{frame}[fragile]{Kompletní test}
  ... se nachází v data/bundler.
  \begin{block}{Gemfile}
  {\scriptsize
  \begin{verbatim}
