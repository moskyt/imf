...
\date{akademický rok 2020/2021, 19. října 2020}
...
\begin{frame}{}
  \begin{itemize}
    ...
    \item první kroky ve zpracování dat (čtení ze souboru, zpracování CSV tabulky) -- musíme dotáhnout
  \end{itemize}
\end{frame}

\section{Zpracování tabulek}
